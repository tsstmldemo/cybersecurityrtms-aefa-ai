Scaling [cybersecurityrtms-aefa-ai] With Kubernetes
===========================

Generated On: 2025-04-04 18:46:51 UTC
...
Based on your TML solution [cybersecurityrtms-aefa-ai] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`cybersecurityrtms-aefa-ai.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-cybersecurityrtms-aefa-ai.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingresscybersecurityrtms-aefa-ai.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f qdrant.yml -f privategpt.yml -f cybersecurityrtms-aefa-ai.yml

cybersecurityrtms-aefa-ai.yml
------------------------

.. important::
   Copy and Paste this YAML file: cybersecurityrtms-aefa-ai.yml - and save it locally.
...
.. code-block:: YAML
   ...
   ################# cybersecurityrtms-aefa-ai.yml
     ...
     kind: Deployment
     metadata:
       name: cybersecurityrtms-aefa-ai
     spec:
       selector:
         matchLabels:
           app: cybersecurityrtms-aefa-ai
       ...
       template:
         ...
         spec:
           ...
           - name: cybersecurityrtms-aefa-ai
             ...
             - name: SOLUTIONNAME
               value: 'cybersecurityrtms-aefa-ai'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_ai_dag-cybersecurityrtms-aefa'
             - name: GITUSERNAME
               value: 'tsstmldemo'
             - name: GITREPOURL
             ...
             - name: step4ajsoncriteria # STEP 4a 
               value: 'uid=tactic,filter:allrecords~subtopics=technique,technique,technique~values=FinalAttackScore,FinalPatternScore,RTMSSCORE~identifiers=FinalAttackScore,FinalPatternScore,RTMSSCORE~datetime=TimeStamp~msgid=kafkakey~latlong='                           
   ...
   ---
     ...
     kind: Service
     metadata:
       name: cybersecurityrtms-aefa-ai-visualization-service
       labels:
         app: cybersecurityrtms-aefa-ai-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/cybersecurityrtms-aefa-ai 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-cybersecurityrtms-aefa-ai.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-cybersecurityrtms-aefa-ai.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-cybersecurityrtms-aefa-ai.yml
